  ...
  return (
    <section className="py-24 relative bg-gradient-to-b from-emerald-50 to-white overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/3 w-64 h-64 rounded-full bg-emerald-500/5"></div>
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-xl mx-auto text-center mb-16">
          ...
          <h2 className="text-4xl font-bold mb-4 text-gray-900">
            Discover <span className="text-emerald-600">Ourika</span> Travels
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            <div className="absolute -top-4 -left-4 w-24 h-24 rounded-full bg-emerald-100 z-0"></div>
            <div className="absolute -bottom-4 -right-4 w-32 h-32 rounded-full bg-teal-100 z-0"></div>
            ...
            <div className="absolute -bottom-6 -right-6 bg-white rounded-lg p-4 shadow-lg z-20">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full bg-gradient-to-r from-emerald-500/20 to-teal-500/20 flex items-center justify-center">
          ...
          <div className="space-y-8">
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                ...
                >
                  <div className="w-12 h-12 rounded-full bg-gradient-to-r from-emerald-500/10 to-teal-500/10 flex items-center justify-center mb-4">
            ...
            <a
              href="/about"
              className="group inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-emerald-600 to-teal-500 text-white rounded-full font-medium shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
            >
              Learn More About Us
