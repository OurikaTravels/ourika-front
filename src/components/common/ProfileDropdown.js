        ...
        <div className={`absolute right-0 mt-2 w-72 rounded-lg shadow-lg border z-50 ${
          ...
          <div className="p-4">
            ...
            <div className="space-y-2">
              <DropdownItem icon={<CreditCard className="h-5 w-5" />} label="Currency" value="MAD (د.م.)" theme={theme} />
...
const DropdownItem = ({ icon, label, value, theme }) => (
  <button className={`w-full flex items-center justify-between py-2 px-1 rounded-md transition-colors duration-200 ${
