        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {features.map((feature, index) => (
              <div 
                key={index}
                className="p-6 sm:p-8 rounded-xl transform transition-all duration-300 hover:-translate-y-1 bg-white hover:shadow-xl border border-gray-100"
              >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
            {values.map((value, index) => (
              <div 
                key={index}
                className="flex items-start space-x-4 p-6 sm:p-8 rounded-xl transform transition-all duration-300 hover:-translate-y-1 bg-white hover:shadow-xl border border-gray-100"
              >
